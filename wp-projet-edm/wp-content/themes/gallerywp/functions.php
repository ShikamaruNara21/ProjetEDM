...
function gallerywp_setup() {
    ...
    if ( !(gallerywp_get_option('enable_widgets_block_editor')) ) {
...
function gallerywp_content_width() {
    $gallerywp_content_width = 892;

    if ( is_page_template( array( 'template-full-width-page.php', 'template-full-width-post.php' ) ) ) {
       $gallerywp_content_width = 1230;
    }
    if ( is_404() ) {
        $gallerywp_content_width = 1230;
    }

    $GLOBALS['content_width'] = apply_filters( 'gallerywp_content_width', $gallerywp_content_width ); /* phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedVariableFound */
}
