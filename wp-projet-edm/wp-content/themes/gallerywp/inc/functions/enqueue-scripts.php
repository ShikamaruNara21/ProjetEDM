...
function gallerywp_scripts() {
    ...
    $gallerywp_primary_menu_active = FALSE;
    if ( !gallerywp_get_option('disable_primary_menu') ) {
        $gallerywp_primary_menu_active = TRUE;
    }
    $gallerywp_secondary_menu_active = FALSE;
    if ( !gallerywp_get_option('disable_secondary_menu') ) {
        $gallerywp_secondary_menu_active = TRUE;
    }
    ...
    wp_enqueue_script('gallerywp-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), NULL, true );
    wp_enqueue_script('gallerywp-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), NULL, true );
    ...
    wp_localize_script( 'gallerywp-customjs', 'gallerywp_ajax_object',
        array(
            ...
            'primary_menu_active' => $gallerywp_primary_menu_active,
            'secondary_menu_active' => $gallerywp_secondary_menu_active,
