...
function gallerywp_other_options($wp_customize) {
    ...
    $wp_customize->add_setting( 'gallerywp_options[enable_widgets_block_editor]', array( 'default' => false, 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'gallerywp_sanitize_checkbox', ) );

    $wp_customize->add_control( 'gallerywp_enable_widgets_block_editor_control', array( 'label' => esc_html__( 'Enable Gutenberg Widget Block Editor', 'gallerywp' ), 'section' => 'sc_other_options', 'settings' => 'gallerywp_options[enable_widgets_block_editor]', 'type' => 'checkbox', ) );
