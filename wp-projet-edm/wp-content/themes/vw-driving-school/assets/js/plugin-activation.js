jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_driving_school_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-driving-school-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-driving-school-plugin-install');
                button.addClass('button-primary vw-driving-school-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-driving-school-recommended-plugins .vw-driving-school-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-driving-school-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-driving-school-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-driving-school-recommended-plugins').css('display','none');
    });
